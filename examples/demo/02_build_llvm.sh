#!/usr/bin/env bash
#
# 02_build_llvm.sh — Step 2: YAML → clang compiler for rv32i
#
# Generates a complete LLVM backend from the rv32i ISA YAML, clones LLVM 18,
# integrates the generated files, and builds clang + llc.
#
# Usage:
#   bash 02_build_llvm.sh [BUILD_DIR]
#   BUILD_DIR=/tmp/my-rv32 bash 02_build_llvm.sh
#
# After building:
...
# Derive the target name from the generated directory (avoids yaml dependency)
