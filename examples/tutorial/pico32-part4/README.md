...
[the compiler build guide](../../../docs/targets/compiler/build-and-use.md).) Run it:
...
[`-t c` / `-t rust`](../../../docs/targets/intrinsics/README.md) emit typed headers -
...
[`-t docs`](../../../docs/targets/reference-manuals/README.md) turns the same
...
Everything so far was software. The [`verilog` target](../../../docs/targets/verilog/README.md)
...
not a finished core (see [the Verilog target's boundaries](../../../docs/targets/verilog/README.md#what-it-is--and-isnt)).
