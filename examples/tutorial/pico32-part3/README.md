...
Long coffee. ([`../scripts/02_build_llvm.sh`](../scripts/02_build_llvm.sh) is
the scripted equivalent.) The result is a clang whose **only** backend is pico32.

## 6. Compile and run

This directory's `programs/` has a minimal bare-metal trio, commented:
